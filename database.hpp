...
namespace Vlinder { namespace RTIMDB {
	...
	public :
		...
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, bool initial_value);
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, int16_t initial_value);
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, int32_t initial_value);
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, uint16_t initial_value);
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, uint32_t initial_value);
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, float initial_value);
		unsigned int createPoint(Details::Producer const *producer, Core::PointType point_type, double initial_value);
		...
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, bool initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, int16_t initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, int32_t initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, uint16_t initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, uint32_t initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, float initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		std::pair< unsigned int, Errors > createPoint(Details::Producer const *producer, Core::PointType point_type, double initial_value RTIMDB_NOTHROW_PARAM) noexcept;
		...
		std::pair< Core::Details::Optional< Core::PointValue >, Errors > read(Core::Details::ROTransaction const &transaction, Core::PointType point_type, unsigned int system_id) const noexcept;
	...
	private :
		...
		Errors dispatch(Details::Timestamp const &timestamp, Core::PointType type, unsigned int id, Core::PointValue const &value) noexcept;
