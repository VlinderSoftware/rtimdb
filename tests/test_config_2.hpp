...
#undef RTIMDB_ALLOW_EXCEPTIONS
#define RTIMDB_ABORT_SELECTION_ON_DUPLICATE_SELECTION
#define RTIMDB_MAX_COMMAND_QUEUE_COUNT 2
#define RTIMDB_COMMAND_QUEUE_CAPACITY 16
#define RTIMDB_MAX_TRANSITION_QUEUE_COUNT 2
